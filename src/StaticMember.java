...
//        Calc 클래스의 멤버 메서드인 abs, max, min 이 모두 정적 멤버이기 떄문에 객체 생성없이 클래스 이름으로 직접 접근이 가능함
//        정적 멤버는 해당 클래스를 객체화하여 사용 시 객체화된 모든 객체들과 함께 메모리 공간을 공유함
        System.out.println(Calc.abs(-5));
        System.out.println(Calc.max(10, 8));
        System.out.println(Calc.min(-3,8));

//        정걱 멤버도 객체 생성 후 사용이 가능함
        Calc c= new Calc();
...
//        정적 멤버를 사용한 연산
        c1.sNum1 = 10;
        c1.sNum2 = 20;
        c1.sResult = c1.sNum1 + c2.sNum2;
        System.out.println("객제 c1의 sResult : " + c1.sResult);
